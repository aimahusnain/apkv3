      ...
      <section className="overflow-hidden pt-[180px] pb-[120px]">
        <div className="container">
          ...
          <div className="flex flex-wrap justify-center items-center px-8">
            {categories.map((catItem) => (
              <button
                onClick={() => router.push(`/blogs/category/${catItem.value}`)}
                className="mr-3 mb-3 inline-flex items-center justify-center rounded-md bg-primary py-2 px-4 text-white duration-300"
                key={catItem.value}
              >
                {catItem.label}
            ...
            <div className="w-full px-4 lg:w-8/12">
              {getLatestBlogForCurrentCategory === null ? (
                ...
                <div>
                  ...
                  <p
                    style={{ wordWrap: "break-word" }}
                    className="mb-8 leading-relaxed text-base font-medium text-body-color sm:text-lg lg:text-base xl:text-lg whitespace-normal"
                  >
                    {/* Add the whitespace-normal class above */}
                    {getLatestBlogForCurrentCategory?.description}
                  </p>
