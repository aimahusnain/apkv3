...
import { mymenuitems } from "@/src/utils";
...
export default function Header() {
  ...
  <NavbarMenuItem key={index} className="flex !items-start justify-center gap-10 h-fit text-3xl">
    ...
    >
      ...
      //             width="170px"
      //             height="41px"
      //             viewBox="0 0 1024 251"
      //             fill="black"
      //             className="dark:fill-white"
      //           >
      //             <path
      //               d="M49.3,60c-0.1-0.3-0.2-0.5-0.4-0.7c-0.2-0.2-0.4-0.3-0.7-0.3c-5.2-0.9-10.5-0.9-15.7,0
      ...
      // c0-0.1,0-0.1,0-0.2L49.3,60z M26.9,116.4l3.9-13C3
      // 4,92.9,37,82.2,39.7,71.2h0.5c3,10.9,5.9,21.7,9.1,32.2l3.8,13H26.9z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M146.5,83.1c-2.1,0-4.1,0.1-6.2,0.4c-0.3,0-0.7,0.2-0.9,0.5c-0.2,0.3-0.4,0.6-0.4,1v69.1c0,0.4,0.1,0.7,0.4,1
      // c0.2,0.3,0.6,0.4,0.9,0.5c4.1,0.5,8.3,0.5,12.4,0c0.3,0,0.7-0.2,0.9-0.5c0.2-0.3,0.4-0.6,0.3-1V85c0-0.4-0.1-0.7-0.3-1
      // c-0.2-0.3-0.6-0.4-0.9-0.5C150.6,83.2,148.6,83.1,146.5,83.1L146.5,83.1z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M146.5,73.4c5,0,9.1-4.1,9.1-9.2c0-5.1-4.1-9.2-9.1-9.2c-5,0-9.1,4.1-9.1,9.2C137.4,69.3,141.4,73.4,146.5,73.4
      // z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M111.1,134.4V56.9c0-0.4-0.1-0.7-0.4-1c-0.2-0.3-0.6-0.4-0.9-0.5c-2-0.3-4.1-0.4-6.2-0.4
      ...
      // c0-0.1-0.1-0.2-0.1-0.2c-0.1-0.1-0.2-0.1-0.3-0.1C119.6,141.8,111.1,140.9,111.1,134.4z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M214.1,145.6h-13.2c-9.1,0-12-2.8-12-7.1c0-1.5,0.4-3,1.1-4.3c0.7-1.3,1.7-2.5,2.8-3.4
      ...
      // C225.5,172.2,217.1,178.5,204.6,178.5z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M314.2,110.4c0-18.4-6.7-28.7-22-28.7c-11.4,0-17.4,4.8-22.7,10.9V55.3c0-0.1,0-0.2-0.1-0.2
      ...
      // c0.1-0.1,0.1-0.2,0.1-0.2L314.2,110.4z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M375,143.3c0-0.1-0.1-0.1-0.1-0.2c-0.1-0.1-0.1-0.1-0.2-0.1c-0.1,0-0.2,0-0.2,0c-0.1,0-0.2,0-0.2,0
      ...
      // c-0.3-3.5-1.2-6.9-2.6-10.1L375,143.3z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M550,119c0-25.1,16.6-39.5,35-39.5S620,94,620,119c0,24.8-16.6,39.1-35,39.1S550,143.8,550,119z M604,119
      // c0-15.9-7.3-26.6-19.1-26.6c-11.8,0-18.9,10.6-18.9,26.6c0,15.9,7.3,26.3,18.9,26.3S604,134.8,604,119z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M729.1,119c0-25.1,16.6-39.5,35-39.5s35,14.5,35,39.5c0,24.8-16.6,39.1-35,39.1S729.1,143.8,729.1,119z
      //  M783.2,119c0-15.9-7.3-26.6-19.1-26.6s-18.9,10.6-18.9,26.6c0,15.9,7.3,26.3,18.9,26.3S783.2,134.8,783.2,119L783.2,119z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M815.4,81.4c4-0.8,8.1-0.8,12.1,0l0.5,0.1l1.2,10.3h0.4c6.9-6.7,14.4-12.3,24.6-12.3
      ...
      // c-0.1-0.2-0.2-0.4-0.2-0.6v-74C815.3,81.5,815.3,81.5,815.4,81.4C815.4,81.4,815.4,81.4,815.4,81.4L815.4,81.4z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M702.8,82.8c-2.1,0-4.1,0.1-6.2,0.4c-0.4,0-0.7,0.2-0.9,0.5c-0.2,0.3-0.4,0.6-0.4,1v70.7c0,0.4,0.1,0.7,0.4,1
      // c0.2,0.3,0.6,0.4,0.9,0.5c4.1,0.5,8.3,0.5,12.4,0c0.3,0,0.7-0.2,0.9-0.5c0.2-0.3,0.4-0.6,0.3-1V84.6c0-0.4-0.1-0.7-0.4-1
      // c-0.2-0.3-0.5-0.4-0.9-0.5C706.9,82.9,704.9,82.8,702.8,82.8L702.8,82.8z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M702.8,73.1c5,0,9.1-4.1,9.1-9.2c0-5.1-4.1-9.2-9.1-9.2c-5,0-9.1,4.1-9.1,9.2C693.7,69,697.8,73.1,702.8,73.1z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M675.2,142.9c-0.1-0.1-0.2-0.3-0.3-0.3c-0.1-0.1-0.3-0.1-0.5,0c-2.3,0.9-4.7,1.4-7.2,1.5
      ...
      // c-0.3-3.5-1.2-6.9-2.6-10.1V142.9z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M513.5,58.5c-0.2,0-0.3,0.1-0.4,0.2c-0.1,0.1-0.2,0.2-0.3,0.4c-2,5.9-22.1,62.5-24.3,69h-0.7
      ...
      // c-4.7-0.9-9.4-0.9-14.1,0L513.5,58.5z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M902.1,119.9c4.4,4.5,8,9.8,10.4,15.6c2.4,5.8,3.6,12.1,3.6,18.4c0,6.3-1.2,12.6-3.6,18.4
      ...
      // C911.4,131.4,907.3,125.2,902.1,119.9L902.1,119.9z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M864.5,251c23.6,0.2,46.3-9,63.1-25.7c16.8-16.6,26.5-39.3,26.7-63.1c0.3-23.8-8.8-46.6-25.3-63.7
      ...
      // C860.3,250,862.4,250.9,864.5,251L864.5,251z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M955,246.1c22.5-22.9,35.2-53.9,35.3-86.2c0.1-32.3-12.4-63.3-34.8-86.4s-52.9-36.4-84.9-37.1
      ...
      // c0.8,0.8,1.7,1.4,2.7,1.8c1,0.4,2.1,0.6,3.2,0.6s2.2-0.2,3.2-0.6C953.4,247.4,954.3,246.8,955,246.1L955,246.1z"
      //               className="st0"
      //             ></path>{" "}
      //             <path
      //               d="M868.6,0c-40.5,0-79.4,16-108.4,44.5c-29,28.5-45.8,67.3-46.8,108.1c1-38.9,17.2-75.8,45.1-102.8
      ...
      // c-14.4-14.5-31.6-26.1-50.4-33.9C909.2,4,889,0,868.6,0z"
      //               className="st0"
      //             ></path>
      //           </svg>
      //         </Link>
